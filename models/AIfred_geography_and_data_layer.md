...
What it needs is not users but GMV, because merchants negotiate on volume. Meaningful terms start somewhere around Rs 25 to 50 crore a year of routed spend.

**Correction, 2026-09-14.** The line that stood here converted that to 4,000 to 7,500 users and was wrong by about nine times. The model routes Rs 48,200 a month per Indian subscriber (`tasks_day` 0.85 x 30.4 days x `txn_share` 0.45 x `atv` Rs 3,500), which is Rs 5.8 lakh a year, so Rs 25 crore a year is about **430 subscribers** and Rs 50 crore about **870**. On the published line the base passes those at months 4 and 9, and the model's own annualised routed spend passes Rs 25 crore at month 4 and Rs 50 crore at month 9. Merchant volume was therefore never the binding constraint; `commerce_start = tri(12, 16, 22)`, the time it takes to sign merchants, is, and no growth rate shortens it. The page that carried the wrong figure is 05, section 9, and it now carries this one.

The assumption worth arguing with is not the take rate but the routed spend: Rs 48,200 a month is roughly ten times what an Indian subscriber pays for the service, and foreign users route three to four times the Indian basket at the same take rate, which is why GMV per user rises to Rs 88,150 by month 60. Both are open items.
